...
\input{Chapters/1_Julia_introduction.tex}

\chapter{A brief introduction to deep learning}
\input{Chapters/2_deep_learning.tex}

\chapter{Parametric machines}
\input{Chapters/3_parametric_machines.tex}


\chapter{Julia's implementation: DLWrappers}
